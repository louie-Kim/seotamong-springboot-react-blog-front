...
//      function  : getBoardResponse 처리함수                        //
...
const getBoardResponse = (responseBody: GetBoardResponseDto|ResponseDto|null) =>{
  ...
  //File객체들을 생성후 boardImageFileList에 업데이트
  convertUrlsToFile(boardImageList).then(boardImageFileList=>setBoardImageFileList(boardImageFileList))

  //작성권한이 없음.
  if(!loginUser||loginUser?.email !== writerEmail ) {navigate(MAIN_PATH()); return}
...
const onImageCloseButtonClickHandler =(deletIndex: number)=>{
  ...
  // filter((url, index) = filter(value , index)
      ...
      <div className='board-update-container'>
        <div className='board-update-box'>
            ...
            <div className='board-update-title-box'>
              <textarea ref={titleRef} className='board-update-title-textarea' rows={1} placeholder='제목을 작성해 주세요' 
            ...
            <div className='board-update-content-box'>
              ...
              <textarea ref={contentRef} className='board-update-content-textarea' placeholder='본문을 작성해 주세요' 
            ...
            <div className='board-update-images-box'>
              ...
              <div className='board-update-image-box'>
                ...
                <img className='board-update-image' src={imageUrl} alt='Board Image' />
                {/* 삭제 버튼 */}
